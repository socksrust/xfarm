...
export const WalletSelect: React.FC<{ wallets: Wallet[]; theme: any }> = ({
  wallets,
  ...
  return (
    <Menu style={{ backgroundColor: secondaryBackground, color: primaryText }}>
      {({ open }) => (
        <>
          <Menu.Button
            ...
            style={{ backgroundColor: secondaryBackground, color: primaryText }}
          >
            <ChevronDownIcon
          ...
          >
            <Menu.Items
              className="absolute right-0 z-20 w-44 rounded-b-md bg-th-bkg-3 px-4 py-2.5 outline-none"
              style={{
