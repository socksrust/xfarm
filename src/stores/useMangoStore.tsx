...
import { rpcUrl } from '../utils/fetch';
...
const ENDPOINT = ENDPOINTS.find((e) => e.name === CLUSTER) as any
...
export type MangoStore = {
  ...
  actions: {
    fetchWalletTokens: (wallet: any) => void
    fetchProfilePicture: (wallet: any) => void
    fetchAllMangoAccounts: (wallet: any) => Promise<void>
...
>(
  subscribeWithSelector((set, get) => {
    ...
    return {
      ...
      actions: {
        async fetchWalletTokens(wallet: any) {
        ...
        async fetchProfilePicture(wallet: any) {
          const set = get().set
